    ...
    <div class="hotelApply wl-gantt">
      <el-card>
        <el-table :data="tableData" border style="width: 100%" :class="dateTypeClass" row-key="id"
          ...
          <el-table-column prop="room" label="线号" align="center" width="140px" fixed="left" :show-overflow-tooltip="true">
          </el-table-column>
          <el-table-column prop="bedName" label="设备号" align="center" width="120px" fixed="left"
      ...
      <!-- 右边抽屉 -->
      <el-drawer title="基础信息" v-model="showDrawer" size='40%'>
        <div class="drawer_box">
          <el-form :model="drawerForm" :inline="true" label-width="100px">
            <el-form-item label="开始时间">
              <el-date-picker v-model="drawerForm.beginTime" type="date" placeholder="选择日期" value-format='yyyy-MM-dd'
                disabled>
              </el-date-picker>
            </el-form-item>
            <el-form-item label="结束时间">
              <el-date-picker v-model="drawerForm.endTime" type="date" placeholder="选择日期" value-format='yyyy-MM-dd'>
              </el-date-picker>
            </el-form-item>
          </el-form>
  ...
  export default {
    ...
    data() {
      return {
        tableData: [
          {
            ...
            endTime: "2024-12-31",
            liveList: [
              { beginTime: "2024-12-03", endTime: "2024-12-04" },
              { beginTime: "2024-12-06", endTime: "2024-12-08" },
            ],
          },
          {
            id: 2,
            room: "EMGJ-1",
            bedName: "BB",
            beginTime: "2024-12-04 00:00:00",
            endTime: "2024-12-05 00:00:00",
            liveList: [],
          },
          {
            id: 3,
            room: "EMGJ-2",
            bedName: "CC",
            beginTime: "2024-12-05 00:00:00",
            endTime: "2024-12-07 00:00:00",
            liveList: [],
          },
          {
            id: 4,
          ...
          },
          {
            ...
            room: "EMGJ-3",
            bedName: "EE",
            beginTime: "2024-12-06 00:00:00",
            endTime: "2024-12-08 00:00:00",
            liveList: [],
          },
          {
            id: 6,
            room: "EMGJ-3",
            bedName: "FF",
            beginTime: "2024-12-07 00:00:00",
            endTime: "2024-12-09 00:00:00",
            liveList: [],
          },
          {
            id: 7,
        ...
        drawerForm: {},
        // 甘特图
        self_start_date: "2024-12-1", // 项目开始时间
        self_end_date: "2024-12-30", // 项目结束时间
